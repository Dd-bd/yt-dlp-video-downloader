...
- 📦 `install.bat` 一键自动下载 ffmpeg，无需手动配置

---

## 📥 快速下载（推荐）

到本仓库右侧 **Releases** 页面下载最新版 **Source code (zip)**：

1. 解压 zip 到任意文件夹
2. 按下方「准备工作」装好 Python（一次即可）
3. 双击 `install.bat` 安装依赖并自动下载 deno / ffmpeg
4. 双击 `start.bat` 使用
...
1. 双击 **`install.bat`** —— 自动安装依赖并下载 deno 和 ffmpeg（首次约需几分钟）
...
- ffmpeg：双击 `download_ffmpeg.bat` 可单独重下。
